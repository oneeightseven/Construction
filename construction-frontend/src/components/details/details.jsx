        ...
        <div className="row g-4">
          ...
          <div className="col-md-6 col-lg-4">
            <div className="form-group">
              ...
              <input
                className="form-control form-control-lg border-accent-primary bg-light"
                value={work.id}
                readOnly
              />
            </div>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="form-group">
              ...
              <input
                className="form-control form-control-lg border-accent-warning"
                value={work.dateBid}
              />
            </div>
          </div>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="form-group">
              ...
              <input
                className="form-control form-control-lg border-accent-success"
