    ...
    private async Task InitializeDatabase(ApplicationDbContext dbContext, CancellationToken cancellationToken)
    {
        ...
        var works = new[]
        {
            new Work
            {
                ...
                Summ = 150000,
                Description = "Выполнение комплекса строительно-монтажных работ по возведению торгового павильона площадью 45 м² на первом этаже торгового центра. Работы включают устройство металлокаркаса, монтаж перегородок из ГКЛ, устройство витражной конструкции, подключение к существующим электрическим сетям, монтаж освещения и розеточных групп, а также чистовую отделку (покраска стен, укладка напольного покрытия, установка потолка типа «Армстронг»). Работы выполнить в соответствии с проектной документацией и требованиями ТРЦ.",
                Note = "Работы должны выполняться в ночное время (с 22:00 до 08:00) в связи с действующим режимом работы торгового центра. Подрядчику необходимо соблюдать требования по уровню шума и обеспечить сохранность существующих инженерных коммуникаций. Все строительные материалы и оборудование должны ежедневно вывозиться либо складироваться в согласованной зоне."
            },
            new Work
            {
